...
if (current_user_can('edit_posts')){
  wp_nav_menu( array('menu' => 'developers', 'container_class' => 'main-nav' ));
}elseif ( current_user_can('follow_developer_activities') ){
  wp_nav_menu( array('menu' => 'followers', 'container_class' => 'main-nav' ));
}elseif(current_user_can('manage_membership')){
  wp_nav_menu( array('menu' => 'members', 'container_class' => 'main-nav' ));
}else{
  wp_nav_menu( array('menu' => 'visitors', 'container_class' => 'main-nav' ));
}
?>

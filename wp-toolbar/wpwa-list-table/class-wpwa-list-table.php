 ...
 */
class WPWA_List_Table extends WP_List_Table {
    ...
    function __construct() {
        ...
        parent::__construct(array(
                    'singular' => 'developer', //singular name of the listed records
...
*/
    ...
    function process_bulk_action() {
        ...
        if ('follow' === $this->current_action() && isset($_POST['developer'])) {
            ...
            $msg = "Succefully completed.<a href='" . admin_url() . "?page=wpwa_subscriptions'>
    ...
    function prepare_items() {
        ...
        function usort_reorder($a,$b){
            $orderby = (!empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'developer_name'; //If no sort, default to title
...
function wpwa_followers_menu() {
    add_menu_page('Follow Developers', 'Follow  Developers', 'follow_developer_activities', 'wpwa_subscriptions', 'followers_list_page');
}
...
function followers_list_page() {
    ...
    foreach ($user_query->results as $developer) {
        array_push($testListTable->example_data, array("ID" => $developer->data->ID, "developer_name" => $developer->data->display_name));
    }
